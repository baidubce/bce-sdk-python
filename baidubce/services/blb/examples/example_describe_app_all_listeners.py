...
# coding=utf-8
"""
Samples for describe blb app all listeners.
"""
...
if __name__ == '__main__':
    ...
    try:
        resp = app_blb_client.describe_app_all_listener(blb_id='lb-75f648e5')
        print("[example] describe app blb all listener response : {}".format(resp))
