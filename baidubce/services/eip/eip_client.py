...
class EipClient(BceBaseClient):
    ...
    def create_eip(self, bandwidth_in_mbps, name=None, billing=None,
        ...
        if delete_protect is not None:
            body['deleteProtect'] = delete_protect
    ...
    def bind_eip(self, eip, instance_type, instance_id, instance_ip=None, client_token=None,
                 config=None):
        """
    ...
    def list_eips(self, eip=None, instance_type=None, ip_version=None, instance_id=None,
                  status=None, marker=None, max_keys=1000,
                  name=None, eip_ids=None, config=None):
        """
    ...
    def change_eip_to_prepay(self, eip, purchase_length, bandwidth, client_token=None, config=None):
        """
        ...
        if client_token is None:
            client_token = self._generate_default_client_token()
        params = {
            b'action': b'TO_PREPAY',
            b'clientToken': client_token
        }
        return self._send_request(http_methods.PUT, path, params=params,
                                  body=json.dumps(body), config=config)

    def refund_prepay_eip(self, eip, client_token=None, config=None):
        """
        ...
        :return: BceResponse
        """
        path = utils.append_uri(self._get_path(), 'refund', eip)
        if client_token is None:
            client_token = self._generate_default_client_token()
        params = {
            b'clientToken': client_token
    ...
    def update_eip_delete_protect(self, eip, delete_protect, client_token=None, config=None):
        """
        ...
        path = utils.append_uri(self._get_path(), eip, 'deleteProtect')
        if client_token is None:
            client_token = self._generate_default_client_token()
        params = {
            b'clientToken': client_token
