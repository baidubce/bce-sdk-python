...
BOS_IF_NONE_MATCH = b"If-None-Match"

BOS_IF_MODIFIED_SINCE = b"If-Modified-Since"

BOS_IF_UNMODIFIED_SINCE = b"If-Unmodified-Since"

BOS_COND_READ_WRITE_HEADERS = set([BOS_IF_UNMODIFIED_SINCE, BOS_IF_MATCH, BOS_IF_NONE_MATCH])
