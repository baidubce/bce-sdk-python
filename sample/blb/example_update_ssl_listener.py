...
"""
Example for update blb ssl listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.update_ssl_listener(blb_id=blb_id, listener_port=listener_port, 
                                              backend_port=backend_port, scheduler=scheduler, cert_ids=cert_ids) # 更新ssl监听器
        print("[example] update blb ssl listener response : {}".format(resp))
