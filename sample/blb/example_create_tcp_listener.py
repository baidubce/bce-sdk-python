...
"""
Example for create blb tcp policys.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.create_tcp_listener(blb_id=blb_id, listener_port=listener_port, 
                                              backend_port=backend_port, scheduler=scheduler) # 创建tcp监听器
        print("[example] create blb tcp listener response : {}".format(resp))
