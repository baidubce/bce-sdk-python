...
"""
Example for update blb http listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.update_http_listener(blb_id=blb_id, listener_port=listener_port, 
                                               backend_port=backend_port, scheduler=scheduler) # 更新http监听器
        print("[example] update blb http listener response : {}".format(resp))
