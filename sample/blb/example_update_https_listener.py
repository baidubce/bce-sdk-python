...
"""
Example for update blb https listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.update_https_listener(blb_id=blb_id, listener_port=listener_port, 
                                                backend_port=backend_port, scheduler=scheduler) # 更新https监听器
        print("[example] update blb https listener response : {}".format(resp))
