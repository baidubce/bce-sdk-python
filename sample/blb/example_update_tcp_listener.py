...
"""
Example for update blb tcp listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.update_tcp_listener(blb_id=blb_id, listener_port=listener_port, 
                                              backend_port=backend_port, scheduler=scheduler) # 更新tcp监听器
        print("[example] update blb tcp listener response : {}".format(resp))
