...
"""
Example for describe blb udp listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.describe_udp_listener(blb_id=blb_id) #查询udp监听器
        print("[example] describe blb tcp listener response : {}".format(resp))
