...
"""
Example for create blb https listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.create_https_listener(
            blb_id=blb_id, listener_port=listener_port, backend_port=backend_port, scheduler=scheduler, 
            cert_ids=cert_ids) # 创建HTTPS监听器
        print("[example] create blb https listener response : {}".format(resp))
