...
"""
Example for update blb udp listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.update_udp_listener(blb_id=blb_id, listener_port=listener_port,
                                              backend_port=backend_port, scheduler=scheduler) # 更新udp监听器
        print("[example] update blb udp listener response : {}".format(resp))
