...
"""
example for describe ssl listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.describe_ssl_listener(blb_id=blb_id, listener_port=listener_port, config=config)
        print("[example] describe ssl listener response :%s" % resp)
