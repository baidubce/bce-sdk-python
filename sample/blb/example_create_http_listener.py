...
"""
Example for create blb http listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.create_http_listener(blb_id=blb_id, listener_port=listener_port,
                                               backend_port=backend_port, scheduler=scheduler) # 创建HTTP监听器
        print("[example] create blb http listener response : {}".format(resp))
