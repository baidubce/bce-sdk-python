...
"""
example for describe https listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = blb_client.describe_https_listener(blb_id=blb_id, listener_port=listener_port, config=config)
        print("[example] describe https listener response :%s" % resp)
