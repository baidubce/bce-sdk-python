...
def test_delete_endpoint(endpoint_client, endpoint_id):
    """
    delete the endpoint with specified endpointId
    ...
    Args:
        ...
        :param endpoint_id: id of endpoint to be delete
    ...
    """
    try:
        response = endpoint_client.delete_endpoint(endpoint_id)
        print(response)
...
if __name__ == '__main__':
    ...
    # 查询可挂载的公共服务
    test_delete_endpoint(endpoint_client, endpoint_id)
