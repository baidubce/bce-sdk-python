...
"""
Example for edit Authentication of user service.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = client.user_service_edit_auth(service, authList, None, config)
        print("[example] edit auth to service publish point response :%s" % resp)
