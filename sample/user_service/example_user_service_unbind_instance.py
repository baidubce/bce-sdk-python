...
"""
Example for unbind instance from user service.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = client.user_service_unbind_instance(service, None, config)
        print("[example] user service unbind instance response :%s" % resp)
