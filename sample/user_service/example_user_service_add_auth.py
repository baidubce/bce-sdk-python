...
"""
Example for add Authentication to user service.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = client.user_service_add_auth(service, authList, None, config)
        print("[example] user service add auth response :%s" % resp)
