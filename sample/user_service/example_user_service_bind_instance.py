...
"""
Example for user service bind instance.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        lbid = "lb-xxxxx"                # 绑定服务发布点的lbid
        resp = client.user_service_bind_instance(lbid, service, None, config)
        print("[example] user service bind instance response:%s" % resp)
