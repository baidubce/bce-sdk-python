...
if __name__ == "__main__":
    ...
    result = vpn_client.get_vpn_ssl_user(vpn_id='vpn-b4cs1yrbnrn9')

    print(result.ssl_vpn_users)
    for ssl_user in result.ssl_vpn_users:
        print(ssl_user.user_id)
        print(ssl_user.user_name)
        print(ssl_user.description)
