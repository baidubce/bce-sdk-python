# -*- coding: utf-8 -*-
"""
example for disassociate et channel.
"""
...
if __name__ == "__main__":
    ...
    try:
        resp = et_client.disassociate_et_channel(et_id=et_id, et_channel_id=et_channel_id,
                                                 extra_channel_id=extra_channel_id, client_token=str(uuid.uuid4()))
        print("Disassociate et channel response: %s" % resp)
