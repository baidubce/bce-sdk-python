...
if __name__ == '__main__':
    ...
    try:
        resp = client.delete_et_channel_route_rule(et_id, et_channel_id,
            et_channel_route_rule_id)  # 删除专线通道路由规则
        print("[example] delete et channel route rule response: %s." % resp)
