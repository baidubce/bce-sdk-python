...
"""
Example for rejecting EIP transfer tasks.
"""
...
def test_reject_eip_transfer(eip_client, transfer_id_list):
    """
    ...
    """
    try:
        res = eip_client.reject_eip_transfer(transfer_id_list=transfer_id_list)
        print(res)
...
if __name__ == '__main__':
    ...
    # 要拒绝的转移任务ID列表（最多30个）
    transfer_id_list = ["tf-9aiozl9h"]
    # 拒绝转移任务
    test_reject_eip_transfer(eip_client, transfer_id_list)