...
"""
example for update app tcp listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        description = 'updated tcp listener'  # 监听器描述
        resp = app_blb_client.update_app_tcp_listener(blb_id=blb_id, listener_port=listener_port,
                                                      scheduler=scheduler,
                                                      tcp_session_timeout=tcp_session_timeout,
                                                      description=description,
                                                      config=config)
        print("[example] update app tcp listener response :%s" % resp)
