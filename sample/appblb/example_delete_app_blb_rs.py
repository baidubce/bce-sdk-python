...
if __name__ == "__main__":
    ...
    backend_server_list = ["Your Serverid"]  # 云服务器ID列表

    try:
        # delete server group rs
        resp = app_blb_client.delete_app_blb_rs(blb_id, sg_id, backend_server_list)
        print("[example] delete server group rs response :%s" % resp)
