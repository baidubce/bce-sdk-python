...
"""
Example for describe appblb udp listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = app_blb_client.describe_app_udp_listener(blb_id=blb_id, listener_port=listener_port)
        print("[example] describe app blb UDP listener response : {}".format(resp))
