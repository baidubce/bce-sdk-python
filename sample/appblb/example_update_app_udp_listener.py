...
"""
example for update app udp listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        description = 'updated udp listener'  # 监听器描述
        resp = app_blb_client.update_app_udp_listener(blb_id=blb_id, listener_port=listener_port,
                                                      scheduler=scheduler,
                                                      udp_session_timeout=udp_session_timeout,
                                                      description=description,
                                                      config=config)
        print("[example] update app udp listener response :%s" % resp)
