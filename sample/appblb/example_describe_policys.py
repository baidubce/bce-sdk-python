...
"""
Example for describe appblb policys.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = app_blb_client.describe_policys(blb_id=blb_id, listener_port=listener_port)
        print("[example] describe app blb listener policy response : {}".format(resp))
