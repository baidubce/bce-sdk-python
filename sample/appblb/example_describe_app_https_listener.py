...
"""
Example for describe appblb https listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = app_blb_client.describe_app_https_listener(blb_id=blb_id, listener_port=listener_port)
        print("[example] describe app blb HTTPS listener response : {}".format(resp))
