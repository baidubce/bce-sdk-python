...
"""
Example for describe appblb tcp listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = app_blb_client.describe_app_tcp_listener(blb_id=blb_id, listener_port=listener_port)
        print("[example] describe app blb TCP listener response : {}".format(resp))
