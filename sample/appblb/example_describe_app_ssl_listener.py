...
"""
Example for describe appblb ssl listener.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp = app_blb_client.describe_app_ssl_listener(blb_id=blb_id, listener_port=listener_port)
        print("[example] describe app blb SSL listener response : {}".format(resp))
