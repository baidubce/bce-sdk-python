...
"""
Example for delete appblb policys.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        policy = 'Your PolicyId'   # 策略的policy ID
        policys_list = []
        policys_list.append(policy)
        resp = app_blb_client.delete_policys(blb_id=blb_id, listener_port=listener_port, policys_list=policys_list)
