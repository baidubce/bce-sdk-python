...
if __name__ == "__main__":
    ...
    memberList = ["Your Ipmemberid"]  # ip组成员ID列表

    try:
        # delete ip group member
        resp = app_blb_client.delete_app_ip_group_member(blb_id, ip_group_id, memberList)
        print("[example] delete ip group member response :%s" % resp)
