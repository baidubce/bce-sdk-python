...
if __name__ == "__main__":
    ...
    #     response = bcc_client.create_instance_by_spec(spec='bcc.g4.c1m1', image_id='m-FBfg6s7W', billing=billing,
    #                                                   purchase_count=2)
    #     print response
    # except BceHttpClientError as e:
    #     if isinstance(e.last_error, BceServerError):
    ...
    try:
        billing = bcc_model.Billing(paymentTiming='Prepaid', reservationLength=2, reservationTimeUnit='Year')
        response = bcc_client.auto_release_instance(spec='bcc.g4.c1m1', image_id='m-FBfg6s7W', billing=billing,
                                                      purchase_count=2)
        print response
    except BceHttpClientError as e:
        if isinstance(e.last_error, BceServerError):
