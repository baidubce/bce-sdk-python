...
def test_get_lbdc(lbdc_client, lbdc_id):
    """
    Query the lbdc cluster info with specified lbdc_id
    ...
    """
    try:
        response = lbdc_client.get_lbdc(lbdc_id)
        print(response)
...
if __name__ == '__main__':
    ...
    lbdc_id = b'lbdc-xxx'
    # 查询lbdc集群详情
    test_get_lbdc(lbdc_client, lbdc_id)
