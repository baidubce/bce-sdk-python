# -*- coding: utf-8 -*-
"""example for DuMemory list_mental_models."""
...
if __name__ == "__main__":
    ...
    try:
        options = dumemory_model.ListMentalModelsOptions(
            detail="metadata", limit=20, offset=0)
        resp = client.list_mental_models(conf.BANK_ID, options)
        print("List mental models response: %s" % resp)
