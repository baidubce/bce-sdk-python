# -*- coding: utf-8 -*-
"""example for DuMemory update_mental_model."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        resp = client.update_mental_model(conf.BANK_ID, created.mental_model_id, request)
        print("Update mental model response: %s" % resp)
