# -*- coding: utf-8 -*-
"""example for DuMemory delete_mental_model."""
    ...
    try:
        created = client.create_mental_model(
            ...
            dumemory_model.new_create_mental_model_request(
                ...
                source_query="Sample mental model to be deleted.",
            ),
        )
        resp = client.delete_mental_model(conf.BANK_ID, created.mental_model_id)
        print("Delete mental model response: %s" % resp)
