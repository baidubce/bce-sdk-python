...
def test_delete_snat_rule(nat_client, nat_id, snat_rule_id):
    """
    ...
    """
    try:
        res = nat_client.delete_snat_rule(nat_id, snat_rule_id)
        return res
...
if __name__ == "__main__":
    ...
    nat_id = "nat-xx"
    snat_rule_id = "rule-xx"
    
    # delete a snat rule
    res = test_delete_snat_rule(nat_client, nat_id, snat_rule_id)