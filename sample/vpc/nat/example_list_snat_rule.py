...
def test_list_snat_rule(nat_client, nat_id, marker=None, maxKeys=None):
    """
    listing snat rule of a specified nat gateway.
    ...
    """
    try:
        res = nat_client.list_snat_rule(nat_id, marker, maxKeys)
        return res
...
if __name__ == "__main__":
    ...
    nat_id = "nat-xx"
    res = test_list_snat_rule(nat_client, nat_id, maxKeys=10)
    print(res.rules)