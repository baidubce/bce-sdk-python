...
def test_delete_ipv6_gateway_rate_limit_rule(ipv6gateway_client, gateway_id, rate_limit_rule_id):
    """
    ...
    """
    try:
        res = ipv6gateway_client.delete_ipv6_gateway_rate_limit_rule(gateway_id, rate_limit_rule_id)
        return res
...
if __name__ == "__main__":
    ...
    res = test_delete_ipv6_gateway_rate_limit_rule(ipv6gateway_client, gateway_id, rate_limit_rule_id)
