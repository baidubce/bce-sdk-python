...
"""
The configuration for tsdb admin client test.
"""
import logging
import baidubce
...
HOST='tsdb.<region>.baidubce.com' #such as tsdb.bj.baidubce.com
ACCESS_KEY='<your ak>'
SECRET_KEY='<your sk>'

logger = logging.getLogger("baidubce.services.tsdb")
fh = logging.FileHandler("tsdb_admin_test_client.log")
